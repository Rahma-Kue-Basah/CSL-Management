...
import AdminEquipmentUsageHistoryDetailContent from "@/components/admin/history/content/AdminEquipmentUsageHistoryDetailContent";
...
import { mapUse, useUseDetail, useUses, type UseRow } from "@/hooks/use-equipment/use-uses";
