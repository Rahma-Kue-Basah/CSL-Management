  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setUser({
        ...
        role:
          normalizeRoleValue(String(updated.role || form.role || "")) || "-",
        ...
        <div className="mx-auto max-w-3xl rounded-xl border bg-card p-4 shadow-[0_2px_8px_rgba(15,23,42,0.05)]">
          ...
          <div className="mt-4 grid grid-cols-1 gap-4">
            ...
            <DetailField
              ...
              editable={isEditing && canManageUsers}
              onChange={(value) =>
                setForm((prev) => ({ ...prev, id_number: value }))
              }
            />
            <DetailField
              label="User Type"
          ...
          {message ? (
            <div className="mt-4 rounded-md border border-sky-200 bg-sky-50 px-3 py-2 text-xs text-sky-800">
              {message}
            </div>
          ) : null}
          ...
          {canManageUsers ? (
            <div className="mt-6 flex flex-col gap-2 sm:flex-row">
              ...
              <Button
                ...
                className={
                  isEditing
                    ? "bg-[#0052C7] text-white hover:bg-[#0048B4] sm:min-w-32"
                    : "sm:min-w-32"
                }
                onClick={() => {
                  if (isEditing) {
