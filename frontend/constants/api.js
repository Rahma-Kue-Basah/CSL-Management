...
const API_AUTH_ADMIN_PROFILE_DETAIL = (id) => `${API_AUTH_ADMIN_PROFILE}${id}/`;
...
const API_BOOKING_DETAIL = (id) => `${API_BOOKINGS}${id}/`;
const API_BOOKING_APPROVE = (id) => `${API_BOOKINGS}${id}/approve/`;
const API_BOOKING_REJECT = (id) => `${API_BOOKINGS}${id}/reject/`;
const API_BOOKING_COMPLETE = (id) => `${API_BOOKINGS}${id}/complete/`;
const API_BOOKINGS_BY_MONTH = `${API_BOOKINGS}by-month/`;

// REGION: Borrows API Endpoints
const API_BORROWS = `${API_BASE_URL}/api/borrows/`;
const API_BORROW_DETAIL = (id) => `${API_BORROWS}${id}/`;
const API_BORROW_APPROVE = (id) => `${API_BORROWS}${id}/approve/`;
const API_BORROW_REJECT = (id) => `${API_BORROWS}${id}/reject/`;
const API_BORROW_RETURN = (id) => `${API_BORROWS}${id}/return/`;
...
const API_EQUIPMENT_DETAIL = (id) => `${API_EQUIPMENTS}${id}/`;

// REGION: Images API Endpoints
const API_IMAGES = `${API_BASE_URL}/api/images/`;
const API_IMAGE_DETAIL = (id) => `${API_IMAGES}${id}/`;

// REGION: Rooms API Endpoints
const API_ROOMS = `${API_BASE_URL}/api/rooms/`;
const API_ROOM_DETAIL = (id) => `${API_ROOMS}${id}/`;
const API_ROOM_AVAILABILITY = (id) => `${API_ROOMS}${id}/availability/`;
